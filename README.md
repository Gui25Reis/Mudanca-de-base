...
=======
Esse programa faz uma conversão de bases de número inteiro positivos apenas.
>>>>>>> Stashed changes
...
=======
- Baixando a pasta [_main](https://github.com/Gui25Reis/Mudanca-de-base/tree/main/_main) voce consegue ter acesso ao código. As requisições estão declaradas na parte de [Requerimentos](#Requerimentos). Para executar o programa basta rodar o arquivo ```main```.

## Requerimentos
O programa foi feito em python na versão ```3.8.5``` com a adição de uma biblioteca externa para a Interface Gráfica (GUI) chamada PyQt5. Para poder ter acesso total ao código basta instalar com o pip.
>>>>>>> Stashed changes
